...
const SummerOfSTEM = ({ componentName }) => {
	...
	const listItemsSummerOfSTEM = [
		...
		{ copy: 'Having fun and building lasting friendships' },
	];
	...
	return (
		<>
			...
			<div className={`page ${componentName}`}>
				...
				<ProgramDates
					image1='https://res.cloudinary.com/dtjvswb7v/image/upload/v1710786700/game-development-single-image_eic0qd.jpg'
